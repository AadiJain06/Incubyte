...
import { ArrowLeft, ShoppingBag, Loader2, Receipt, Calendar } from 'lucide-react';
...
export default function PurchaseHistory() {
  ...
  const { data: purchases, isLoading } = useQuery<PurchaseWithSweet[]>({
    queryKey: ['purchases', user?.id],
    queryFn: async () => {
      return await purchasesAPI.getHistory();
    },
    enabled: !!user,
  });
