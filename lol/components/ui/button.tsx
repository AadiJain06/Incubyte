...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold font-body ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-candy hover:shadow-lifted hover:-translate-y-0.5",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-soft hover:shadow-lifted",
        ...
        candy: "gradient-candy text-primary-foreground shadow-candy hover:shadow-lifted hover:-translate-y-0.5 hover:scale-105",
        mint: "bg-candy-mint text-candy-chocolate hover:bg-candy-mint/80 shadow-soft hover:-translate-y-0.5",
        caramel: "gradient-caramel text-primary-foreground shadow-soft hover:shadow-lifted hover:-translate-y-0.5",
      },
      size: {
